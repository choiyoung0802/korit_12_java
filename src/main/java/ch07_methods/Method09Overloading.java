...
/*
    method overloading
        ...
        근데 문자열끼리 더하는게 필요해서 add는 못 쓰니까 connect를 씁시다.
        ...
        method overloading의 장점 :
            ...
            과 같이 자료형을 달리 하는 동일한 이름을 가지는 메서드'들'을 정의하거나,
            ...
            그러면 메서드 명들도 동일하고, 걔네가 뭐 매개변수 유형이가 개수가 차이가 있겠지만
            기능도 같으니까 머리가 안 아프다는 장점이 있다고 할 수 있습니다.
 */
public class Method09Overloading {
    ...
    public static void main(String[] args) {
        ...
        method1.add(2, 3);
        method1.add("집가고싶다", 3);
        System.out.println(method1.add("아무말", "대잔치"));
    }
}
