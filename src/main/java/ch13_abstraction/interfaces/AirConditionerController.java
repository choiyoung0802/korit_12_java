...
public class AirConditionerController {
    ...
    public void onPressedAirPowerButton() {
        powerButton.onPressed();
    }
    public void onPressedAirDownButton() {
        temperatureDownButton.onPressed();
    }
    public void onDownAirDownButton() {
        temperatureDownButton.onDown();
    }
    public void onPressedAirUpButton() {
        temperatureUpButton.onPressed();
    }
    public String onUpAirUpBotton() {
