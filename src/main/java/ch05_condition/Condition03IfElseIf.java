...
public class Condition03IfElseIf {
    public static void main(String[] args) {
        ...
        // 근데 보니까 좀 귀찮은 부분이 있습니다. 회원 등급에 그때그때 sout으로 써줘야 한다는 점이
        ...
        /*
            풀이법 # 1의 경우에는 20점 이하의 포인트를 가지게 될 경우
            실행되는 부분이 없습니다.

            풀이법 # 2의 경우에는 반복되는 print문이 없어도 된다는 점에서
            장점을 가지고 있지만 20점 이하인 경우에도 59번 라인이 실행되고,
            20점 이하의 경우 userGrade가 ""에서 변화되지 않기 때문에
            결과값이
            회원 등급 :
