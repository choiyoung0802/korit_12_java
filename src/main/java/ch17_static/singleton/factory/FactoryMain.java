...
//        System.out.println(smartPhone1);
        ...
        // 이상의 이유 : @AllArgsConstructor를 적용했는데 걔는 기본적으로 public 입니다.
        // 그래서 @AllArgsConstructor(access = AccesssLevel.PACKAGE)로 수정해주면 11번 라인이 오류가 발생합니다.
...
/*
    이상의 코드를 실행시켰을 때 알 수 있는 점은 어느 공장의 어떤 공장에서 메서드를 호출했는가와는 상관없이
    createSerialNumber() 메서드를 호출한 결과가 단일한 Samsung 객체에서
    비롯된다는 것을 알 수 있습니다.(싱글톤 때문에)
    그래서 다우싀 공장 객체에서 각각 produceSmartPhone() 메서드를
