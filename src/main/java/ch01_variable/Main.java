...
public class Main {
    public static void main(String[] args) {
        ...
        scoreKorean = 99;           // 초기화(데이터에 처음으로 들어가는 값)
        System.out.println(scoreKorean);
        scoreEnglish = 50;          // 변수에 데이터를 재대입 (재대입할 때는 자료형을 명시하지 않는다.)
         ...
         */
        // 변수 : 값이 바뀔 수 있음.
        System.out.println("국어 점수(변경전) : " + scoreKorean); // ctrl + f = 검색
        ...
        /*
            ...
            문자(하나짜리)를 세 번 더해ㅔㅆ을 경우 더 이상 문자가 아니라 문자열로 인식되기 때문에
            원하는 방식으로 출력되지 않습니다.
            ...
            큰따옴표("")는 "문자열"을 표시하시 위한 기호라고 알아두면 되겠습니다.
