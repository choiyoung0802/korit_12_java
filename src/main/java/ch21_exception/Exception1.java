...
/*
    ...
    그러면 모든 자료형이 클래스 형태로 정의되는 Java의 특성 상 자주 일어나는 예외 클래스들은
    이미 개발자들이 정의를 해놓았습니다.
 */
...
//            System.out.println(result);
//        }
        // 즉, 이상의 코드는 아까 확인한 예외와 관련된 클래스를 사용하지 않는 예시 라고 할 수 있습니다.
        ...
        } catch (Exception e) { // 예외도 서로 상속 처리가 되는데 거의 가장 상위의 예외 관련 클래스에 해당합니다.
