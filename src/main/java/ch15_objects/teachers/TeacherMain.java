...
public class TeacherMain {
    public static void main(String[] args) {
        ...
        System.out.println(result1);    // 결과값 : 현재는 false. 재정의 후 true로 바뀌어있음

        /*
            이상의 코드에서 중요한 점은 재정의 전과 후가 결과값이 다르다는겁니다.
            Teacher에서 .equals()를 재정의하기 전에는 false가 떴었습니다.
            그 때는 teacher1와 teacher2의 주소지까지 확인하여 같은지 아닌지의 여부를 확인했다면
            재정의 이후에는 field에 입력된 데이터가 '동일한지만'을 체크하기 때문입니다.
         */
        ...
        // 배열이네 그러면
        System.out.println(fields); // 주소값만 나오겠네
