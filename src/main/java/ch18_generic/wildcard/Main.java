...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            문제가 되지 않습니다. 그러면 animal field에 Tiger / Human / Car 객체가
            들어가있다는 점은 여기 main에서 확인 안 됩니다. 코드 다른 곳 까보셔야 합니다.
         */
...
//        animalData3.showData();   // 오류 발생
        /*
            ...
            AnimalData 클래스를 확인하셔야 하는데, 저희가 (Animal)이라고 형변환을 시키는
            부분 때문이겠네요. Car를 Animal로 형변환 시킬 수 있는 근거가 없는 상태니까요.
         */
...
//        animalData6.showData();   // 오류 발생
        System.out.println(animalData4);    // 결과값 : 주소지나옴
//        System.out.println(animalData6);    // 결과값 : null
...
//        }
//        System.out.println(animalData100.getAnimal());  // 결과값 : null
//        animalData100.setAnimal(new Car());
//        System.out.println(animalData100.getAnimal());  // 결과값 : 주소지나옴
    }
}
