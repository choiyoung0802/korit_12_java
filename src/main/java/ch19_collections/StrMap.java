...
public class StrMap {
    public static void main(String[] args) {
        ...
        System.out.println(strMap1); // 순서 보장 x
        ...
        // # 2 .replace();
        koreanScores2.replace("김육", 789.2); // 결과값에 포함 안됨. 이유 ↓
        ...
        // 그럼 아제 우리 수준에서는 strMap1.entrySet()의 호출 결과가 일종의 형변환이 이루어진 로직이 있고
...
//        List<Map.Entry<String, String>> entryList1 = strMap1.
        // 근데 이상의 코드는 보니까 안 되네요. Map을 List로 바꾸고 싶다면 Set을 경유하도록 하겠습니다.
...
//        Set<String> valueSet = strMap1.values();    // .values()가 있는거 보니까
        ...
        // 로 써보면 되지 않을가 라고 스스로 추측할 수 있으면 됩니다.
        /*
