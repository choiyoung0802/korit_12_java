...
public class StrList {
    public static void main(String[] args) {
        ...
        // 그리고 최초에 List의 방의 개수를 정하지 않았죠. 앞아서 방이 늘어납니다.

        // Array와의 차이점 # 3 - 출력 방식
        // strArray를 출력만 하시오.
        System.out.println(Arrays.toString(strArray)); // 결과값 : [김영, null, null, null, 김사]
        // List의 출력
        System.out.println(strList); // 결과값 : [Java, python, JavaScript, C#, C++]
        ...
        System.out.println(removeElem1 + " 삭제 여부 : " + isRemoved); // 결과값 : JavaScript 삭제 여부 : true
        System.out.println(strList); // 결과값 : [Java, python, C#, C++]
        ...
        System.out.println(strList); // 결과값 : [C#, C++, Java, python]
        // 내림차순
        Collections.sort(strList, Comparator.reverseOrder());
        System.out.println(strList); // 결과값 : [python, Java, C++, C#]
        ...
        System.out.println();
        /*
            이상의 경우에서 배열일 때는 구경도 못하는 향ㅅ아된 for문의 장점이 있는데
