        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    scanner.nextLine();
                    System.out.println(newBook + " 도서가 " + newNum + "권 추가되었습니다.");
                    book.put(newBook, newNum);
                    break;
                case 2:
                    System.out.print("재고를 변경할 도서명을 입력하세요 >>> ");
                    newBook = scanner.nextLine();
                    if(!book.containsKey(newBook)) {
                        System.out.println("해당도서가 재고에 없습니다.");
                        break;
                    }
                    System.out.print("새로운 재고 수량을 입력하세요 >>> ");
                    newNum = scanner.nextInt();
                    book.replace(newBook, newNum);
                    System.out.println(newBook + " 도서가 " + newNum + "권으로 변경되었습니다.");
                    break;
                case 3:
