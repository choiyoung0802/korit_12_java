...
import ch14_casting.game.items.*;   // * 의 발음은 에스터리스크(asterisk라고 하고, all의 의미를 가집니다)
...
public class Inventory {
    ...
    public Inventory(int capacity) {
        this.weaponsSlots = new Weapon[capacity];
    }
    ...
    public void attackAll() {
        ...
        for (Weapon weapon : weaponsSlots) {
            if (weapon != null) {
                weapon.attack();
                continue;
            }
