...
public class Main {
    public static void main(String[] args) {
        ...
        /*
            이상의 코드에서 처음에 38번 라인을 업캐스팅 # 2 방식으로 처리하려고 했을 때,
            오류가 나는 것은 당연한 부분입니다.
            ...
            캐스팅 개념과 연결됩니다. ch14~16 사이에 다루게 될 예정.
