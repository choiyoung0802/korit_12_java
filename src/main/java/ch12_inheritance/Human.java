...
public class Human extends Animal{
    public Human() { // human 객체 생성시 출력됨.
        System.out.println("사람 객체가 생성되었습니다.");
    }

    @Override
    public void move() { // Animal 클래스 메서드 재정의
        System.out.println("사람이 두 발로 걷습니다.");
    }

    public void read(String title) { // 고유 메서드 정의
        System.out.println(getAnimalName() + "이(가) " + title + "를 읽는 중입니다.");
    }
}
